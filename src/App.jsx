...
import { HashRouter as Router, Routes, Route, Navigate, HashRouterProvider } from 'react-router-dom';
...
import ViewRequestCourse from './Admin/ViewRequestCourse'
/////CHORDMANAGER
...
function App() {
  return (
    <HashRouterProvider hashType="hashbang">
      <Router>
        <Routes>
          <Route
            path="/"
