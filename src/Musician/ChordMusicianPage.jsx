                            ...
                            <TableBody>
                                {
                                    currentItems.map((song, index) => (
                                        <TableRow key={index} onClick={() => navigate(`/viewSongMusician/` + song.id)} style={{ cursor: 'pointer' }}>
                                            ...
                                            {song.link != null ?
                                                <TableCell><Link to={song.link} style={{ textDecoration: 'none', cursor: 'pointer' }}>{song.link.substring(0, 30)}...</Link></TableCell> :
...
export default ChordMusicianPage;